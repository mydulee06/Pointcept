...
data = dict(
    ...
    train=dict(
        ...
        transform=[
            ...
            dict(
                ...
                keys=("coord", "grid_coord", "segment", "edge", "edge_ds", "spl_t", "spl_c", "spl_k", "spl_coef"),
                # Keys used for point features, "feat"
                feat_keys=("segment_onehot",),
            ),
        ],
        test_mode=False,
    ),
    ...
    test=dict(
        ...
        transform=[
            ...
            dict(
                type="Collect",
                keys=("coord", "grid_coord", "color", "segment", "edge", "edge_ds", "spl_t", "spl_c", "spl_k", "spl_coef"),
                feat_keys=("segment_onehot",),
            ),
        ],
